...
def load(data_dir, subset='train'):
    ...
    if subset=='train':
        trainx, trainy, trainh = unpickle(os.path.join(data_dir, 'celeba_train_set.p'))
        return trainx, trainy, trainh
    elif subset=='test':
        testx, testy, testh = unpickle(os.path.join(data_dir, 'celeba_test_set.p'))
        return testx, testy, testh
    elif subset=='sample':
        samplex, sampley, sampleh = unpickle(os.path.join(data_dir, 'celeba_sample_set.p'))
